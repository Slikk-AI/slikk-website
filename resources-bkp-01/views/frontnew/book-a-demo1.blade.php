                ...
                <div class="product-header_wrapper">
                    ...
                    <div class="product-header_right-wrapper">
                        <div class="product-header_image-wrapper">
                            <img
                                src="{{ url('assets/frontend/image/demo-illustration.png')}}"
                                loading="lazy"
            ...
            <div class="col-md-4-book">
                <div class="demo_form hero_form mb-4">
                    <form class="contact-form " method="post" action="{{url('schedule-call')}}">
                        ...
                        <input type="text" class="form-control inputbox" name="Schedule" placeholder="Schedule" id="datetimepicker" required readonly>
                        ...
                        <div class="row mt-5 mb-4">
                            <div class="checkbox-label-div col-md-6">
                                <label for="schedule" class="label-call">Schedule a call</label>
                            </div>
                            <div class="checkbox-input-div col-md-6">
                                <label class="switch unchecked-div">
                                <input type="checkbox" required id="checkbox_checked">
                                <span class="unchecked-slider slider round"></span>
                                </label>
                                <label class="switch checked-div display">
                                    <input type="checkbox" required id="checkbox_checked" checked>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                        <input type="submit" anem="submit" value="Submit" class="btn btn-primary book" style="color:#000;width:60%;border: none;border-radius: 150px;background: #FAF9FF;margin-left: 4rem;padding: 10px;">
