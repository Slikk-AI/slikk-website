...
class Helper
{
	...
	public static  function element_type(){
		$ArrCTA = array(
			...
			'11'=>'Referal Works',
			'12'=>'Left Side Image with listing',
			'13'=>'Right Side Image with listing',
			'14'=>'Share the Referral Link 2',
			'15'=>'Top Tab with Description',
			'16'=>'Description with Video',
			'17'=>'Left Side Video with listing',
		);
		return $ArrCTA;
	}
