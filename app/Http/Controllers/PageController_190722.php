...
class PageController extends Controller
{
   ...
   protected $Page;
	...
	function load_page(){
		...
		if(! file_exists('resources/views/frontend/pages/' . $PageName.'.blade.php')){
		  return view('frontend/pages/load_page',$data);
		}else{
			return view('frontend/pages/'.$PageName,$data);
		}
    }
	function contact(){
		$url = \Request::segment(1);
...
//echo $url;
   //     exit;
	...
	function save_contact(request $response){
		...
		$fromEmail = 'hello@slikk.ai';//'akshay.sole@gmail.com';
		$fromName = 'Support';
   ...
   $meet_link = $input[$rand_keys[0]] . "\n";
		...
		/////////////////////////////////////
		return view('frontend/pages/call_thanks',$data);
	}
