<div class="form-row ContentSectionData" style="display:none;">
						...
						<div class="form-row PDFSectionData" style="display:none;">
						<div class="form-row border-section CopyPDFSectionData" >
							<div class="form-group col-md-12 ">
							<p style="position: absolute;right: 1px;"><a href="javascript:void(0);" class="SectionSectionBox"  onclick="return removeSection(this);">Remove</a></p>
							  <h5 ><input type="checkbox" class="SectionShow" checked> Section <span class="SectionCounter"></span> : </h5>
							...
							<div class="form-group col-md-12">
							  ...
							  <input type="text" class="form-control PDFTtile"  placeholder="Section Title"   />
							  <div class="invalid-data invalid-PDFTtile"></div>
							</div>
							<div class="form-group col-md-12">
							  <label for="SectionPDF">PDF</label><br>
							   <input type="file" class="SectionPDF" placeholder="PDF" accept="application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint,
text/plain, application/pdf" >
							   <input type="hidden" class="ReportHiddenPDF">
						...
						<div class="form-row VideoSectionData" style="display:none;">
						<div class="form-row border-section CopyVideoSectionData" >
							<div class="form-group col-md-12 ">
							<p style="position: absolute;right: 1px;"><a href="javascript:void(0);" class="SectionSectionBox"  onclick="return removeSection(this);">Remove</a></p>
							  <h5 ><input type="checkbox" class="SectionShow" checked> Section <span class="SectionCounter"></span> : </h5>
							...
							<div class="form-group col-md-12">
							  ...
							  <input type="text" class="form-control VideoTtile"  placeholder="Section Title"   />
							  <div class="invalid-data invalid-VideoTtile"></div>
							</div>
							<div class="form-group col-md-12">
							  <label for="SectionVideo">Video</label><br>
							   <input type="file" class="SectionVideo" placeholder="Video" accept="video/*" >
							   <input type="hidden" class="ReportHiddenVideo">
