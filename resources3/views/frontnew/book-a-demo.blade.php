                    ...
                    <div class="col-md-4-book">
                        <div class="demo_form hero_form mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <i class="fa fa-refresh mt-4" id="btnrefresh" aria-hidden="true" onclick="GenerateCaptcha();"></i>
                                    </div>
                                    <span id="msg" style="color:red;margin-left: 1rem;margin-bottom: 1rem;"></span>
                                </div>
                                <!-- <div class="row mb-2">
                                    <div class="col-md-12">
                                        <span id="error" style="color:red;margin-left: 1rem;"></span>                                        
                                    </div>    
                                </div> -->
...
<script>
  ...
  form.addEventListener('submit', function(event) {
    // Select the fields you want to make required
    const name = document.getElementById('name');
    const email = document.getElementById('email');
    const country = document.getElementById('country');
    const phone = document.getElementById('phone');
    const users = document.getElementById('users');
    const txtCompare = document.getElementById('txtCompare');

    // Check if the fields are empty
    if (name.value.trim() === '' || email.value.trim() === '' || country.value.trim() === '' || phone.value.trim() === '' || users.value.trim() === '' || txtCompare.value.trim() === '') {
      //alert('Please fill out all required fields');
      document.getElementById("msg").innerHTML= "Please fill out all required fields";
...
<script>
  ...
  form.addEventListener('copy', function(event) {
