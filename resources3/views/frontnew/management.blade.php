                    ...
                    <div class="layout-2-col is-reverse">
                        <div class="feature_image-wrapper">
                            <div class="tab_image-wrapper is-left">
                                                            <img src="http://34.221.127.72/assets/page/Project Management Done Right When You Build Workflow.png" loading="lazy" width="545" alt="Illustration showing product feature" class="tab_image-1">
                                                                <div class=""></div>
                            </div>
                        </div>
                        <div class="feature_content-wrapper">
                            ...
                            <div class="margin-top margin-medium">
                                ...
                                <ul class="text-ul">
                                                                        <li style="background: url('http://34.221.127.72/assets/frontend/image/work 1.png') no-repeat left center;">Project managers can prepare workflows the way you want for better efficiency and productivity</li>
                                                                        <li style="background: url('http://34.221.127.72/assets/frontend/image/work 1.png') no-repeat left center;">Team can track the entire project from start to finish with complete visibility</li>
                                                                        <li style="background: url('http://34.221.127.72/assets/frontend/image/work 1.png') no-repeat left center;">Project teams can create detailed views making project planning easy</li>
                                                                        <li style="background: url('http://34.221.127.72/assets/frontend/image/work 1.png') no-repeat left center;">Slikk’s Gantt Charts, Calendar views & other features enable easy project management</li>
                                                                        <li style="background: url('http://34.221.127.72/assets/frontend/image/work 1.png') no-repeat left center;">Leaders can create subtasks to break down a task into smaller steps</li>
                                                                    </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="padding-top padding-xhuge">
                <div class="feature_component">
                    <div class="layout-2-col is-reverse">
                        <div class="feature_image-wrapper">
                            <div class="tab_image-wrapper is-left">
                                                            <img src="http://34.221.127.72/assets/page/Hit Project Goals with Slikk’s Project Management.png" loading="lazy" width="545" alt="Illustration showing product feature" class="tab_image-1">
                                                                <div class=""></div>
                            </div>
                        </div>
                        <div class="feature_content-wrapper">
                            ...
                            <div class="margin-top margin-medium">
                                ...
                                <ul class="text-ul">
                                                                        <li style="background: url('http://34.221.127.72/assets/frontend/image/work 1.png') no-repeat left center;">Define employee goals along with project milestones for better project management</li>
                                                                        <li style="background: url('http://34.221.127.72/assets/frontend/image/work 1.png') no-repeat left center;">Slikk’s dashboard lets you see everything at a glance to give clarity to the managers</li>
                                                                        <li style="background: url('http://34.221.127.72/assets/frontend/image/work 1.png') no-repeat left center;">Track time and set clear project expectations to complete tasks before time</li>
                                                                        <li style="background: url('http://34.221.127.72/assets/frontend/image/work 1.png') no-repeat left center;">Slikk’s visual widgets allows you to bring important project indicators like the percentage of tasks left</li>
                                                                        <li style="background: url('http://34.221.127.72/assets/frontend/image/work 1.png') no-repeat left center;">Set timer for each task and know the amount of time spent on each task</li>
                                                                    </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="faq-div-border mt-5">
                                    ...
                                    <p class="faq-p a display">Slikk's <a href="http://34.221.127.72/use-case/software-development"target="_blank">project management software for software development</a> offers numerous benefits to software development teams. With its robust features tailored for the software development lifecycle, it empowers teams to streamline their projects efficiently. Slikk enhances project planning and tracking, allowing teams to allocate tasks, manage deadlines, and monitor progress seamlessly.</p>
                                </div>
                            </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="mb-2">
                            ...
                            <ul>
                                ...
                                <li><span> &nbsp; &nbsp; &nbsp; </span><span>Time management : Slikk's <a href="http://34.221.127.72/features/time-management"target="_blank">time management tools</a> enable you to track hours and allocate resources efficiently.</span></li>
                                ...
                                <li><span> &nbsp; &nbsp; &nbsp; </span><span>Nudge cards : Stay on top of your projects with Slikk's <a href="http://34.221.127.72/features/nudge-cards"target="_blank">Nudge Cards</a>. These gentle reminders ensure that tasks and deadlines are never forgotten.</span></li>
                            </ul>
