  ...
  .header-menu{
    ...
    <header class="header-menu display-desktop">
        ...
        <div class="logo">
            ...
            <img src="http://34.221.127.72/assets/frontend/image/Slikk-Logo-Blue.png" class="logo-img"
        ...
        <ul class="main-ul-m">
            ...
            <li><a href="http://34.221.127.72/pricing" style="line-height: 3rem;margin-left: 0.2rem;">Pricing</a></li>
            <!-- <li><a href="http://34.221.127.72/join-us" style="line-height: 3rem;margin-left: 0.2rem;">Sign in</a></li> -->
