@foreach($PageSectionData as $val_data)
	...
	@if($val_data->element_id==13)
		@include('frontnew.elements.right_side_image_with_listing')
	@endif
	@if($val_data->element_id==12)
		@include('frontnew.elements.left_side_image_with_listing')
	@endif
	...
	@include('frontnew.elements.left_side_video_with_listing')
@endif
	@endforeach