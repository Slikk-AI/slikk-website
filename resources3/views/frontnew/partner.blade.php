        ...
        <div class="padding-top padding-xxhuge banner-padding">
            <div class="container-large">
                <div class="row">
                        ...
                        <div class="home-header_wrapper">
                            <div class="center-wrapper home-header_left-wrapper">
                                ...
                                <div class="margin-vertical margin-custom1">
                                    ...
                                    <a href="http://34.221.127.72/partner_form" class="button">
                                        Apply
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <img class="banner" src="http://34.221.127.72/assets/frontend/image/icons/Group 289897.svg" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="layout-2-col">
                        ...
                        <div class="feature_image-wrapper">
                            <div class="tab_image-wrapper element-listen-image-div">
                                    <img src="http://34.221.127.72/assets/frontend/image/icons/Group 289861.svg" loading="lazy" width="545" alt="Illustration showing product feature" class="tab_image-1 element-listen-image">
                                    <div class=""></div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="page-padding">
        <div class="container-large">
            <div class="padding-top padding-xhuge">
                            ...
                            <div class="card">
                                <div class="card-div">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div>
                                                <img class="icon" src="http://34.221.127.72/assets/frontend/image/icons/Vector (4).svg" alt="">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card other-div-bg">
                                    <div class="card-div">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div>
                                                    <img class="icon" src="http://34.221.127.72/assets/frontend/image/icons/Vector (5).svg" alt="">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="card">
                                    <div class="card-div">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div>
                                                    <img class="icon" src="http://34.221.127.72/assets/frontend/image/icons/Vector (6).svg" alt="">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="card other-div-bg">
                                    <div class="card-div">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div>
                                                    <img class="icon" src="http://34.221.127.72/assets/frontend/image/icons/Vector (7).svg" alt="">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="card">
                                <div class="card-div">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div>
                                                <img class="icon" src="http://34.221.127.72/assets/frontend/image/icons/Vector (8).svg" alt="">
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="div3a">
                    <img src="http://34.221.127.72/assets/frontend/image/Slikk-Logo-Blue.png" alt="">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="banner-padding" style="background:#fff;">
                    <div class="row">
                        <div class="col-md-4 col-div-padding">
                            <div class="last-div">
                                <img src="http://34.221.127.72/assets/frontend/image/icons/Group 289865.svg" alt="image"> 
                            </div>
                        </div>
                        <div class="col-md-4 col-div-padding">
