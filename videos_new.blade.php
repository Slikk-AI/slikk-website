...
function toggleClass(){
  document.getElementById("play").classList.toggle('goDown');
    ...
    <div class="container2">
        <img src="https://clickup.com/landing/images/v2/bg_gradient__demo.svg" alt="Snow" style="width:100%;">
    ...
    <div class="container" style="padding-top: 5%;">
        ...
        <div class="row row-cols-3" style="border-radius: 60px; background-color: #f8f7fe; gap: 57px;">
            ...
            <div class="col" id="up-silde" style="width: 360px;
                ...
                animation: fadein 1s;">
                <div class="embed-responsive embed-responsive-16by9" style="padding: 0 33px; height: 100%; width: 100%;">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/tA8h_exda3E" allowfullscreen style="border-radius: 11px;
                    margin-top: -14px;
        ...
        <div class="container" style=" background-color: #f7f6fe; padding: 0;">
            ...
            animation: fadein 1s;">
                    <div class="embed-responsive embed-responsive-16by9" style="padding: 0 33px; height: 100%; width: 100%;">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/tA8h_exda3E
" allowfullscreen style="border-radius: 11px;
    ...
    <div class="container">
        <div class="row" style="background-color:#fff2f4;;">
            ...
            <div class="col">
                <div class="embed-responsive embed-responsive-16by9" style="margin: 22px; height: 100%;">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/tA8h_exda3E
