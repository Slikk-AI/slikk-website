                    ...
                    <div class="layout-2-col">
                        <div class="feature_content-wrapper">
                            ...
                            <ul class="text-ul">
                                ...
                                <li style="background: url('https://hub.slikk.ai/assets/frontend/image/team 1.png') no-repeat left center;">{{$val_element_array['element_title']}}</li>
                                @endforeach
                            </ul></div>
                        </div>
                        <div class="feature_image-wrapper">
                            ...
                            @if($val_data->image!='')
                                ...
                                />
                                @else
                                <img src="https://hub.slikk.ai/assets/img/block1.png" class="tab_image-1">
								@endif
                                <div class=""></div>
                            </div>
                        </div>
