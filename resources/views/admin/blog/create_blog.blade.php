					...
					@csrf
						<div class="form-row">
							<div class="form-group col-md-10">
							  ...
							  <input name="title" type="text" id="title" class="form-control" placeholder="Title" required value="{{($report_data)?$report_data->table_contents:''}}">
							  <div class="invalid-data invalid-title"></div>
							</div>
							<div class="form-group col-md-2">
							  <label for="PublishDate">Publish Date</label>
							  <input name="PublishDate" type="date" class="form-control" id="PublishDate" placeholder="dd-mm-yyyy" value="{{($report_data)?date('d-m-Y', strtotime($report_data->publish_date)):''}}"  />
						...
						<div class="form-row">
							<div class="form-group col-md-7" >
							  ...
							  <input name="pressurl" type="text" class="form-control" id="pressurl" placeholder=" URL" value="{{($report_data)?$report_data->url:''}}"  />
							...
							<div class="form-group col-md-2">
							  ...
							  <select name="Category" id="Category" class="form-control" placeholder="Category" >
								...
								<option value="{{$category_d->id}}" {{(($report_data) && $report_data->category_id==$category_d->id)?'selected':''}}>{{$category_d->category_name}}</option>
								@endforeach
							  </select>
						...
						<div class="form-row CopySectionType">
							...
							<div class="form-group col-md-10">
							  ...
							  <select name="SectionType" id="SectionType" class="form-control" placeholder="Section Type" onchange="addMoreContentSectionData(this.value);">
								...
								<option value="Content Section" {{(($report_data) && $report_data->publish_type=='Content Section')?'selected':''}}>Content Section</option>
								<option value="Image Section" {{(($report_data) && $report_data->publish_type=='Image Section')?'selected':''}}>Image Section</option>
							  </select>
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <textarea name="metatitle" rows="3" class="form-control">{{($report_data)?$report_data->metatitle:''}}</textarea>
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <textarea name="metadesc" rows="3" class="form-control">{{($report_data)?$report_data->metadata:''}}</textarea>
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <textarea name="metakeywords" rows="3" class="form-control">{{($report_data)?$report_data->metdakeyword:''}}</textarea>
