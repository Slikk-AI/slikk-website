    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
					@if(session()->has('ReportSectionMsg'))
					<div class="xp-alert">
						<div class="alert alert-success" role="alert">
						{{session('ReportSectionMsg')}}
						</div>								 
					</div>
					@endif
                    <form method="post" action="{{url('submit_blog_section_sequence')}}" enctype="multipart/form-data">
					@csrf
						<div class="form-row">
						<label>Report Title : {{$reportDetails[0]->title}}</label>
						</div>
						<div class="form-row">
							<div class="dd nestable col-md-12" id="nestable">
								<ol class="dd-list">
								  ...
								  <li class="dd-item" data-id="1" data-name="Home" data-slug="home-slug-1" data-new="0" data-deleted="0">
									<div class="dd-handle">Section {{$SectionData->section_sequence}} ({{$SectionData->section_type}}): {{$SectionData->title}} </div>
