<div class="xp-rightbar">  
                    ...
                    <ul class="list-inline mb-0">
                        ...
                        <li class="list-inline-item mr-0">
                            <div class="dropdown xp-userprofile">
                                <a class="dropdown-toggle user-profile-img" href="#" role="button" id="xp-userprofile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{admin_url.'assets/images/topbar/user.jpg'}}" alt="user-profile" class="rounded-circle img-fluid"><span class="xp-user-live"></span></a>
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="xp-userprofile">
                                    <a class="dropdown-item" href="#">Welcome, {{Helper::getUserName()}}</a>
                                    <a class="dropdown-item" href="{{url('/profile')}}"><i class="mdi mdi-account mr-2"></i> Profile</a>
                                    <a class="dropdown-item" href="{{url('/logout')}}"><i class="mdi mdi-logout mr-2"></i> Logout</a>
                                </div>
                            </div>                                   
                        </li>
                    </ul>
    ...
    <div class="xp-footerbar">
        <footer class="footer">
            <p class="mb-0">© 2020 {{website_name}} - All Rights Reserved.</p>
        </footer>
    </div>
    <!-- End XP Footerbar -->
</div>