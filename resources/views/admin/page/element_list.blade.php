        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
				<div class="row">
					...
					<div class="col-md-6" style="text-align:right;">
						<div class="card-header bg-white">
							...
							<a href="{{url('add_content_for_page/'.$page_id)}}" class="btn btn-primary">Add Element</a>
							@endif
						</div>
                ...
                <div class="card-body">
					...
					<input type="hidden" name="PageId" id="PageId" value="{{$page_id}}">
...
function deleteData(Id){
	...
	$.ajax({
	type:"DELETE",
	url:"/pagecontentdeleteData/"+Id,
	data:{
		"_token": "{{ csrf_token() }}",
		id:Id,
		table:'mr_page_content_details'
		},
