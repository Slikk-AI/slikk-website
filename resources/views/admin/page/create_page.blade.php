        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
					...
					@endif
                    <form method="post" action="{{url('submit_page')}}" enctype="multipart/form-data">
					@csrf
						<div class="form-row">
							<div class="form-group col-md-12">
							  <label for="Title">Title</label>
							  <input name="title" type="text" id="tiny_title" class="form-control" placeholder="Title" required value="{{($report_data)?$report_data->table_contents:''}}">
...
<option value="teams">Teams</option>
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <textarea name="description" rows="15" class="form-control tinytextarea" id="tiny_bottom">{{($report_data)?$report_data->description:''}}</textarea>
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <input name="BannerTitle" type="text" id="BannerTitle" class="form-control" placeholder="Banner Title" value="">
							  <div class="invalid-data invalid-title"></div>
							</div>
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <textarea name="BannerDescription" rows="15" class="form-control tinytextarea" id="BannerDescription"></textarea>
							  <div class="invalid-data invalid-desc"></div>
							</div>
						...
						<div class="form-row">
							<div class="form-group col-md-6">
							  ...
							  <input type="hidden" name="HiddenBannerBackgroundImage" id="HiddenBannerBackgroundImage" value="">
							</div>
							<div class="form-group col-md-6">
							  <label for="BannerImage">Banner Image</label>
							   <input type="file" name="BannerImage"  id="BannerImage" accept="image/*">
							  <div class="invalid-data invalid-BannerImage"></div>
							  <input type="hidden" name="HiddenBannerImage" id="HiddenBannerImage" value="">
							</div>
						</div>
						<div class="form-row">
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <textarea name="meta_title" rows="3" id="tiny_meta_title" class="form-control">{{($report_data)?$report_data->metatitle:''}}</textarea>
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <textarea name="meta_description" rows="3" id="tiny_disc" class="form-control">{{($report_data)?$report_data->metadata:''}}</textarea>
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <textarea name="meta_keywords" rows="3" id="tiny_key" class="form-control">{{($report_data)?$report_data->metdakeyword:''}}</textarea>
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <input name="q1" type="text" class="form-control" id="q1" placeholder="Question 1" value="{{($report_faq_data)?$report_faq_data->q1:''}}" />
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <input name="a1" type="text" class="form-control" id="a1" placeholder="Answer 1" value="{{($report_faq_data)?$report_faq_data->a1:''}}" />
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <input name="q2" type="text" class="form-control" id="q2" placeholder="Question 2" value="{{($report_faq_data)?$report_faq_data->q2:''}}" />
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <input name="a2" type="text" class="form-control" id="a2" placeholder="Answer 2" value="{{($report_faq_data)?$report_faq_data->a2:''}}" />
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <input name="q3" type="text" class="form-control" id="q3" placeholder="Question 3" value="{{($report_faq_data)?$report_faq_data->q3:''}}" />
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <input name="a3" type="text" class="form-control" id="a3" placeholder="Answer 3" value="{{($report_faq_data)?$report_faq_data->a3:''}}" />
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <input name="q4" type="text" class="form-control" id="q4" placeholder="Question 4" value="{{($report_faq_data)?$report_faq_data->q4:''}}" />
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <input name="a4" type="text" class="form-control" id="a4" placeholder="Answer 4" value="{{($report_faq_data)?$report_faq_data->a4:''}}" />
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <input name="q5" type="text" class="form-control" id="q5" placeholder="Question 5" value="{{($report_faq_data)?$report_faq_data->q5:''}}" />
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <input name="a5" type="text" class="form-control" id="a5" placeholder="Answer 5" value="{{($report_faq_data)?$report_faq_data->a5:''}}" />
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <input name="q6" type="text" class="form-control" id="q6" placeholder="Question 6" value="{{($report_faq_data)?$report_faq_data->q6:''}}" />
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <input name="a6" type="text" class="form-control" id="a6" placeholder="Answer 6" value="{{($report_faq_data)?$report_faq_data->a6:''}}" />
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <input name="q7" type="text" class="form-control" id="q7" placeholder="Question 7" value="{{($report_faq_data)?$report_faq_data->q7:''}}" />
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <input name="a7" type="text" class="form-control" id="a7" placeholder="Answer 7" value="{{($report_faq_data)?$report_faq_data->a7:''}}" />
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <input name="q8" type="text" class="form-control" id="q8" placeholder="Question 8" value="{{($report_faq_data)?$report_faq_data->q8:''}}" />
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <input name="a8" type="text" class="form-control" id="a8" placeholder="Answer 8" value="{{($report_faq_data)?$report_faq_data->a8:''}}" />
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <input name="q9" type="text" class="form-control" id="q9" placeholder="Question 9" value="{{($report_faq_data)?$report_faq_data->q9:''}}" />
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <input name="a9" type="text" class="form-control" id="a9" placeholder="Answer 9" value="{{($report_faq_data)?$report_faq_data->a9:''}}" />
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <input name="q10" type="text" class="form-control" id="q10" placeholder="Question 10" value="{{($report_faq_data)?$report_faq_data->q10:''}}" />
						...
						<div class="form-row">
							<div class="form-group col-md-12">
							  ...
							  <input name="a10" type="text" class="form-control" id="a10" placeholder="Answer 10" value="{{($report_faq_data)?$report_faq_data->a10:''}}" />
