        ...
        <div class=content>
          <div class="wrapper-1">
            <div class="wrapper-2">
              <h1>Thank you !</h1>
              <p></p>
              <button id= "popup__toggle" class="go-home" style="background:#00d65c">
                Watch a Video
              </button>
                  ...
                  <div class="content w-100">
                    <div class="calendar-container">
                      <div class="calendar">
                        ...
                        <button class="button" id="add-button">Add Date</button>
                      </div>
                    </div>
                    <div class="events-container">
                    </div>
                    <div class="dialog" id="dialog">
                      <h2 class="dialog-header"> Add Time </h2>
                      <form class="form" id="form">
                        <div class="form-container" align="center">
                          <!-- <label class="form-label" id="valueFromMyButton" for="name">Name</label>
                          <input class="input" type="text" id="name" maxlength="36" value="85">
                          <label class="form-label" id="valueFromMyButton" for="count">Number of people to invite</label>
                          <input class="input" type="number" id="count" min="0" max="1000000" maxlength="7"> -->
                          <div><button type="button" class="btn btn-outline-primary btn-c-1" id="time-btn2" value="9.00 AM">9.00 AM</button>
                          <button type="button" class="btn btn-outline-primary btn-c-2" id="time-btn2" value="10.00 AM">10.00 AM</button>
                          <button type="button" class="btn btn-outline-primary btn-c-3" id="time-btn2" value="11.00 AM">11.00 AM</button>
                          <button type="button" class="btn btn-outline-primary btn-c-4" id="time-btn2" value="12.00 PM">12.00 PM</button>
                          <button type="button" class="btn btn-outline-primary btn-c-5" id="time-btn2" value="1.00 PM">1.00 PM</button>
                          <button type="button" class="btn btn-outline-primary btn-c-6" id="time-btn2" value="2.00 PM">2.00 PM</button>
                          <button type="button" class="btn btn-outline-primary btn-c-7" id="time-btn2" value="3.00 PM">3.00 PM</button>
                          <button type="button" class="btn btn-outline-primary btn-c-8" id="time-btn2" value="4.00 PM">4.00 PM</button>
                          <button type="button" class="btn btn-outline-primary btn-c-9" id="time-btn2" value="5.00 PM">5.00 PM</button>
                        </div>
                          <input type="button" value="Cancel" class="button" id="cancel-button" style="    margin-top: 20px;
    margin-right: 36px;">
      ...
      <script type="text/javascript" src="https://slikk.ai/js/jquery.min.js "></script>
      <script type="text/javascript" src="https://slikk.ai/js/popper.js"></script>
      <script type="text/javascript" src="https://slikk.ai/js/bootstrap.min.js"></script>
      <script type="text/javascript" src="https://slikk.ai/js/main.js"></script>
...
<!-- popup script end here  -->
      <script>
        (function($) {
          ...
          function show_events(events, month, day) {
            ...
            if (events.length === 0) {
              ...
              var event_name = $("<div class='event-name'>Book Your Time " + month + " " + day + ".</div>");
              $(event_card).css({
        ...
        // new media jquery code end here 
      ...
      <script>
        ...
        $('.btn-c-1').css({"color": "#fff","background-color": "#007bff","border-color": "#007bff"});
        $('.btn-c-8').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-2').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-3').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-4').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-5').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-6').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-7').css({"color": "#007bff","background-color":"#D3D3D3","border-color": "#007bff"});
          $('.btn-c-9').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
        });

        $('.btn-c-2').click(function() {
          const time = $('.btn-c-2').val();
        $('#datetimepicker').val(time);
        $('.btn-c-2').css({"color": "#fff","background-color": "#007bff","border-color": "#007bff"});
        $('.btn-c-1').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-8').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-3').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-4').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-5').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
        ...
        $('#datetimepicker').val(time);
        $('.btn-c-3').css({"color": "#fff","background-color": "#007bff","border-color": "#007bff"});
        $('.btn-c-1').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-2').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-8').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-4').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
        ...
        $('#datetimepicker').val(time);
        $('.btn-c-4').css({"color": "#fff","background-color": "#007bff","border-color": "#007bff"});
        $('.btn-c-1').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-2').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-3').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-8').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
        ...
        $('#datetimepicker').val(time);
        $('.btn-c-5').css({"color": "#fff","background-color": "#007bff","border-color": "#007bff"}); 
        $('.btn-c-1').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-2').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-3').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-4').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
        ...
        $('#datetimepicker').val(time);
        $('.btn-c-6').css({"color": "#fff","background-color": "#007bff","border-color": "#007bff"});
        $('.btn-c-1').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-2').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-3').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-4').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
        ...
        $('#datetimepicker').val(time);
        $('.btn-c-7').css({"color": "#fff","background-color": "#007bff","border-color": "#007bff"});
        $('.btn-c-1').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-2').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-3').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-4').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
        ...
        $('#datetimepicker').val(time);
        $('.btn-c-8').css({"color": "#fff","background-color": "#007bff","border-color": "#007bff"});
        $('.btn-c-1').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-2').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-3').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-4').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
        ...
        //alert(" If you just want value ==>"  + $('.btn-c-9').val()); 
          $('.btn-c-9').css({"color": "#fff","background-color": "#007bff","border-color": "#007bff"});
          $('#datetimepicker').val(time);
          $('.btn-c-1').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-2').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
          $('.btn-c-3').css({"color": "#007bff","background-color": "#D3D3D3","border-color": "#007bff"});
