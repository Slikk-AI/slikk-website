...
@section('content')
    ...
    <div class="container-fluid">
        <div class="header d-flex justify-content-center">
            <a href="{{ url('/')}}">
            <img src="https://slikk.ai/assets/frontend/image/Slikk-Logo-Blue.png" class="logo">
            </a>
            <div class="ml-auto no-mobile">
                <a class="join_waitlist grid" href="https://slikk.ai/join-us#myModal" data-bs-dismiss="modal"
                    data-bs-toggle="modal" style="border: 3px solid #71147e;color: #71147e;">JOIN WAITLIST</a>
            </div>
        </div>
        <input type="hidden" id="success_referal">
            ...
            <div class="col-md-5 banner_content">
                <div class="banner_text">
                    <h1>
                        ...
                        One Platform to <span class="text-capitalize">Communicate, Collaborate</span>,
                        <div>and Get <span class="text-capitalize">Work Done</span>!</div>
                    </h1>
                    <div class="mt-5">
                        <a href="https://slikk.ai/join-us#myModal" role="button"
                            class="join_waitlist_blue w-100 text-center" data-bs-dismiss="modal" data-bs-toggle="modal"
                            id="join" style="background: #71147e;border: 3px solid #71147e;color: #fff;">
                            JOIN WAITLIST
                        </a>
                    </div>
                </div>
            </div>
            <div class="col img-slides">
                <div id="carouselExampleControls" data-interval="500" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            <img src="https://slikk.ai/assets/single/Image 7.png" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="https://slikk.ai/assets/single/Image 8.png" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="https://slikk.ai/assets/single/Image 9.png" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="https://slikk.ai/assets/single/Image 10.png" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="https://slikk.ai/assets/single/Image 11.png" class="d-block w-100" alt="...">
                        </div>

                        <div class="carousel-item">
                            <img src="https://slikk.ai/assets/single/Image 12.png" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="https://slikk.ai/assets/single/Image 13.png" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="https://slikk.ai/assets/single/Image 14.png" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="https://slikk.ai/assets/single/Image 15.png" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="https://slikk.ai/assets/single/Image 16.png" class="d-block w-100" alt="...">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>You will be invited to the early access exclusively by flatshare. Top 1000 on the waitlist will
                            be invited to early access First.</p>
                        <form class="joining-form mt-6 contact-form" action="{{ url('save_contact') }}" method="post">
                            @csrf
                            <div class="row">
                    ...
                    <div class="modal-footer" style="margin-bottom: 19px;padding-top:20px">


                        <input type="submit" anem="submit" value="Book A Demo" class="join_waitlist_blue w-100 text-center"
                            style="color:#71147e!important;margin-top:20px;background: #ffff;border: #71147e;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer>
        <div class="row">
            <div class="col-md-8 margin-bottom-res">
                <span>
                    <img src="https://slikk.ai/assets/single/72.png" class="d-inline" style="width: 20px;">
                </span>
                connect@slikk.ai
            </div>
            <div class="col align-right">
                <ul class="d-inline-flex list-unstyled">
                    <li class="terms"><a href="{{ url('terms') }}">Terms</a></li>
                    <li class="terms"><a href="{{ url('terms') }}">Privacy</a></li>
                    <li class="terms"><a href="{{ url('terms') }}">Security</a></li>
                </ul>
            </div>
        </div>
    </footer>
