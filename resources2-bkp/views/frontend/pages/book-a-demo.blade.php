...
@section('content')
    ...
    <div class="jumbotron text-center top-banner" style="background: transparent url(img/Component%2051%20–%205.png) 0% 0% no-repeat;
            opacity: 1;
        ...
        <div class="container">
            <div class="row" style="padding-top: 40px;">
                <div class="col-sm-7">
                    <h1 class="hero_title" style="font-size: 33px;">Ready for a conversation?</h1>
                    <p class="hero_desc">We're always excited to answer questions. Or talk about employee work
                        management and how we can have a positive impact on businesses out there.</p>
                    <img src="https://slikk.ai/assets/img/Book-A-Demo-Hero-Image.svg" class="img-responsive  banner-img"
                        style="width: 400px;" />
                ...
                <div class="col-sm-5">
                    <div class="hero_form">
                        ...
                        <form class="contact-form " method="post" action="{{ url('save_contact') }}">
                            ...
                            <input type="email" class="form-control inputbox" name="email" id="email" placeholder="Your Email"
                                required>
                            <label for="name">Your Name</label>
                            ...
                            <input type="text" class="form-control inputbox" name="phone" id="name" placeholder="Your Phone"
                                required>
                            <label for="name">Your Name</label>
                ...
                <textarea class="form-control inputtext" name="msg" id="name" placeholder="Your Query" > </textarea> --}}
                            <label for="name">Your Name</label>
                            <input type="submit" anem="submit" value="Book A Demo" class="btn btn-primary hero_sub"
    ...
    {{-- <div class="container"> --}}
        ...
        <div class="col-sm-10 timeline-right">
            <img src="https://reportindata.com/test/img/Group 926.png" style="width:100%">

        </div>

        <div class="col-sm-2 timeline-right">
        ...
        <!-- <h2 class="section_title" style="margin-top:60px;margin-bottom:70px;text-align:left;">Our Team</h2> -->
  {{-- <div class="row"> --}}
            ...
            {{-- <div class="col-sm-4 card-box">
                <div class="icon-cont">
                    ...
                    <div class="d-flex align-items-center"><img
                            src="https://reportindata.com/test/img/Icon awesome-phone-alt.png"
                            style="width: 30%;margin-left: auto;margin-right: auto;"></div>

                    <p style="text-align:center">+1(415) 2515294</p>
            ...
            <div class="col-sm-4 card-box">
                <div class="icon-cont">
                    ...
                    <div class="d-flex align-items-center"><img
                            src="https://reportindata.com/test/img/Icon material-email.png"
                            style="width: 40%;margin-left: auto;margin-right: auto;"></div>
                    <p style="text-align:center">connect@slikk.ai</p>
                </div>
            </div>
            <div class="col-sm-4 card-box">
                <div class="icon-cont">
                    <h3 class="box-title">Lets Chat</h3>

                    <div class="d-flex align-items-center"><img
                            src="https://reportindata.com/test/img/Icon material-message.png"
                            style="width: 30%;margin-left: auto;margin-right: auto;"></div>
                    <p style="text-align:center">Message Now</p>
        ...
        <div class="container" style="padding-top: 60px;padding-bottom: 60px;">
          <div class="row">
              <div class="col-sm-4 card-box" style="display:flex;">
                  ...
                  {{-- <h3 class="box-title">Work & Forecasting</h3> --}}
                  {{-- <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit...</p> --}}
                  <p class="d-flex align-items-center"><i class="fa fa-phone" aria-hidden="true"
                          style="font-size:40px;color: #FFBB00;"></i></p>
                  <p class="d-flex align-items-center" style="padding-left:10px;">+1(415) 2515294
                  </p>
              </div>
              <div class="col-sm-4 card-box" style="display:flex;">
                  {{-- <div class="icon"><img src="https://reportindata.com/test/img/Icon material-group-work.png"></div> --}}
                  ...
                  <p class="d-flex align-items-center"><i class="fa fa-envelope-o" aria-hidden="true"
                          style="font-size:40px;color: #FFBB00;"></i> </p>
                  <p class="d-flex align-items-center" style="padding-left:10px;">connect@slikk.ai
                  </p>
              ...
              <div class="col-sm-4 card-box" style="display:flex;">
                  ...
                  <p class="d-flex align-items-center"><i class="fa fa-comments-o" aria-hidden="true"
                          style="font-size:40px;color: #FFBB00;"></i></p>
                  <p class="d-flex align-items-center" style="padding-left:10px">Message Now</p>
