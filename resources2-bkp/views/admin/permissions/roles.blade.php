        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
				<div class="row">
					<div class="col-md-6">
						<div class="card-header bg-white">
							<h5 class="card-title text-black">Role List</h5>
						   
						</div>
					</div>
					<div class="col-md-6" style="text-align:right;">
						<div class="card-header bg-white">
						@if(Helper::allow_permission('create-role-management')==1)
                ...
                <div class="card-body">
					...
					@endif
					@if(session()->has('RoleAlreadyExist'))
					<div class="xp-alert">
						<div class="alert alert-danger" role="alert">
						 {{ Session::get('RoleAlreadyExist')}}
						</div>								 
					</div>
					@endif
...
@endsection
@section('script')
@if(Helper::allow_permission('view-role-management-list')==1)
<script>
