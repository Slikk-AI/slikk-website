    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
				<div class="row">
					<div class="col-md-6">
						<div class="card-header bg-white">
							<h5 class="card-title text-black">Permission List</h5>
						   
						</div>
					</div>
					<div class="col-md-6" style="text-align:right;">
						<div class="card-header bg-white">
							<a href="{{url('create_permission')}}" class="btn btn-primary">Create Permission</a>
						</div>
                ...
                <div class="card-body">
					@if(session()->has('PermissionAdded'))
					<div class="xp-alert">
						<div class="alert alert-success" role="alert">
						 {{ Session::get('PermissionAdded')}}
						</div>								 
					</div>
					@endif
					@if(session()->has('PermissionUpdated'))
					<div class="xp-alert">
						<div class="alert alert-success" role="alert">
						 {{ Session::get('PermissionUpdated')}}
						</div>								 
					</div>
					@endif
					@if(session()->has('PermissionAlreadyExist'))
					<div class="xp-alert">
						<div class="alert alert-danger" role="alert">
						 {{ Session::get('PermissionAlreadyExist')}}
						</div>								 
					</div>
					@endif
