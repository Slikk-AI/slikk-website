					...
					@csrf
						<div class="form-row">
							...
							<div class="form-group col-md-2">
							  ...
							  <input name="ESort" type="text" id="ESort" class="form-control" placeholder="Sort" required value="">
						...
						<div class="form-row">
							<div class="form-group col-md-6">
							  ...
							  <input name="ContentTitle" type="text" id="ContentTitle" class="form-control" placeholder="Title" required value="">
							...
							<div class="form-group col-md-4">
							  ...
							  <input type="hidden" id="HidMainImage" name="HidMainImage">
							...
							<div class="form-group col-md-12">
							  ...
							  <textarea name="Description" id="Description" class="form-control Description" placeholder="Element" ></textarea>
							  <div class="invalid-data invalid-Description"></div>
							</div>

							<div class="form-group col-md-12">
								<label for="embed">Embed Video</label>
								<textarea name="embed" id="embed" class="form-control embed" placeholder="Element" ></textarea>
								<div class="invalid-data invalid-embed"></div>
							  </div>
							
						</div>
						<h3 class="element_heading" style="display:none;">Add Element Contents:</h3>
