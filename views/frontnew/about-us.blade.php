...
<head>
    ...
    <title>About Us | Slikk</title>
    <meta name="description" content="Slikk is a platform for cxo&#039;s, managers and teams to boost productivity, engagement, performance and retention. Best easy to use project management software">

    <meta name="language" content="English">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <link rel="canonical" href="http://34.221.127.72/about-us">
...
<style>
        ...
        /* color: var(--unnamed-color-ffffff); */
        text-align: left;
        font: normal normal bold 52px/60px Axiforma, Arial, serif;
        letter-spacing: 0px;
        /* color: #FFFFFF; */
        opacity: 1;
        }
        ...
        color: var(--unnamed-color-1d2121);
        text-align: center;
        font: normal normal bold 36px/44px Axiforma, Arial, serif;
        letter-spacing: 0px;
        color: #1D2121;
        opacity: 1;
        }
        ...
        margin-left: auto;
        font-family: Axiforma, Arial, serif;
        font: normal normal normal 22px/26px Axiforma, Arial, serif;
        letter-spacing: 0px;
        color: #1D2121;
        ...
        margin-left: auto;
        font-family: Axiforma, Arial, serif;
        font: normal normal normal 30px/39px Axiforma, Arial, serif;
        letter-spacing: 0px;
        color: #1D2121;
        ...
        color: var(--unnamed-color-ffffff);
        text-align: center;
        font: normal normal normal 14px/16px Axiforma, Arial, serif;
        letter-spacing: 0px;
        color: #FFFFFF;
        padding: 3px;
        width: 100px;
...
<style>
            ...
            .hero_title {
                ...
                font: normal normal bold 30px/37px Axiforma, Arial, serif;
            }
            ...
            .bottop-cont ul li {
                ...
                font: normal normal normal 18px/27px Axiforma, Arial, serif;
            }
...
<style>
        ...
        .grid__list{
          ...
          margin: 0 6px 15px;
          transition: opacity .1s cubic-bezier(0.5, 0, 0.5, 1),transform .4s cubic-bezier(0.165, 0.84, 0.44, 1),-webkit-transform .4s cubic-bezier(0.165, 0.84, 0.44, 1);
        }
        .menu_icon{
          width:40px;
          height:40px;
        ...
        .text-align-center-use-case{
          text-align: center!important;
        }
        .text-align-center-use-case:hover{
          color:#5433FF;
        }
        .use-case-content{
          padding-left:4rem;
        }
        .content-border-learn{
          flex: 0 0 41.666667% !important;
          max-width: 41.666667% !important;
        }
        .padding-learn{
        ...
        @media screen and (max-width: 1034px), screen and (max-height: 320px){
            .nav-divv {
                margin-right: 0%;
            }
        }
...
<header class="header-menu display-mobile">
    <nav class="header-nav">
      <div class="logo">
        <a href="/" aria-current="page" class="nav_brand-link w-nav-brand w--current" aria-label="home">
          <img src="http://34.221.127.72/assets/frontend/image/Slikk-Logo-Blue.png"
      ...
      <ul class="nav__list">
        ...
        <div class="nav-divv">
            <li class="nav__item dropdownn"><a href="#" class="nav__link dropdown__link" id="product-header">Products <i class="fa fa-angle-down dropdown__icon"></i></a>
            <div class="megamenu height-megamenu product-menu">
                <ul class="content">
                <li class="megamenu__item header__megamenu">Features</li>
                <ul class="grid__ul">
                    ...
                    <div class="megamenu__link">
                        <a href="http://34.221.127.72/features/360-degree-visibility">360° Visibility</a>
                        <p>Our teams have been split - juggling between spreadsheets, docs and emails.</p>
                    </div>
                    </li>
                    <li class="grid__list megamenu__item">
                    <div class="menu_icon">
                    ...
                    <div class="megamenu__link">
                        <a href="http://34.221.127.72/features/time-management">Time Management</a>
                        <p>Enables you to track time, work hours, and the actual productivity of your employees.</p>
                    </div>
                    </li>
                    <li class="grid__list megamenu__item">
                    <div class="menu_icon">
                    ...
                    <div class="megamenu__link">
                        <a href="http://34.221.127.72/features/task-management">Task Management</a>
                        <p>Task management tool is the way to plan and execute tasks without any chaos.</p>
                    </div>
                    </li>
                    <li class="grid__list megamenu__item">
                    <div class="menu_icon">
                    ...
                    <div class="megamenu__link">
                        <a href="http://34.221.127.72/features/goal-management">Goal Management</a>
                        <p>Get more done in less time, exceed expectations, and improve productivity.</p>
                    </div>
                    </li>
                    <li class="grid__list megamenu__item">
                    <div class="menu_icon">
                    ...
                    <div class="megamenu__link">
                        <a href="http://34.221.127.72/features/kanban-boards">Kanban Boards</a>
                        <p>Optimize the output of your teams by intelligently routing work to the right team.</p>
                    </div>
                    </li>
                    <li class="grid__list megamenu__item">
                    <div class="menu_icon">
                    ...
                    <div class="megamenu__link">
                        <a href="http://34.221.127.72/features/gantt-charts">Gantt Charts</a>
                        <p>See overlapping activities and task dependencies with more clarity.</p>
                    </div>
                    </li>
                    <li class="grid__list megamenu__item">
                    <div class="menu_icon">
                    ...
                    <div class="megamenu__link">
                        <a href="http://34.221.127.72/features/file-sharing">File Sharing</a>
                        <p>File Sharing for better ideas, faster progress, employee retention, etc.</p>
                    </div>
                    </li>
                    <li class="grid__list megamenu__item">
                    <div class="menu_icon">
                    ...
                    <div class="megamenu__link">
                        <a href="http://34.221.127.72/features/reporting-and-analytics">Reporting & Analytics</a>
                        <p>Business process insights, sprint reports, test analytics, project signoff reports, etc.</p>
                    </div>
                    </li>
                    <li class="grid__list megamenu__item">
                    <div class="menu_icon">
                    ...
                    <div class="megamenu__link">
                        <a href="http://34.221.127.72/features/nudge-cards">Nudge Cards</a>
                        <p>Business process insights, sprint reports, test analytics, project signoff reports, etc.</p>
                    </div>
                    </li>
                    <li class="grid__list megamenu__item">
                    ...
                    <div class="megamenu__link">
                        <a href="http://34.221.127.72/features/schedule-meeting">Schedule Meeting</a>
                        <p>Business process insights, sprint reports, test analytics, project signoff reports, etc.</p>
                    </div>
                    </li>
                    <li class="grid__list megamenu__item">
                    ...
                    <div class="megamenu__link">
                        <a href="http://34.221.127.72/features/import">Import</a>
                        <p>Business process insights, sprint reports, test analytics, project signoff reports, etc.</p>
                    </div>
                    </li>
                    <li class="grid__list megamenu__item">
                    ...
                    <div class="megamenu__link">
                        <a href="http://34.221.127.72/features/docs">Docs</a>
                        <p>Business process insights, sprint reports, test analytics, project signoff reports, etc.</p>
                    </div>
                    </li>
                </ul>
                <div class="text-align-center">
                    <a href="#">View All <img src="{{ url('assets/frontend/image/arrow (4) 2.png')}}" alt=""></a>
                </div>
                </ul>
                <ul class="content content-border use-case-content">
                <li class="megamenu__item header__megamenu">Use Cases</li>
                <ul class="grid__ul">
                    <li class="grid__list megamenu__item">
                    <div class="menu_icon">
                    ...
                    <div class="megamenu__link">
                        <a href="http://34.221.127.72/use-case/project-management">Project Management</a>
                        <p>Slikk helps your team to plan and collaborate on any project.</p>
                    </div>
                    </li>
                    <li class="grid__list megamenu__item">
                    <div class="menu_icon">
                    ...
                    <div class="megamenu__link">
                        <a href="http://34.221.127.72/use-case/software-development">Software Development</a>
                        <p>Taking care of chaotic requests, deployment delays, and tracking budgets.</p>
                    </div>
                    </li>
                    <li class="grid__list megamenu__item">
                    <div class="menu_icon">
                    ...
                    <div class="megamenu__link">
                        <a href="http://34.221.127.72/use-case/sales">Sales</a>
                        <p>Your team gets more time to focus on engaging customers and winning fans for life.</p>
                    </div>
                    </li>
                    <li class="grid__list megamenu__item">
                    <div class="menu_icon">
                    ...
                    <div class="megamenu__link">
                        <a href="http://34.221.127.72/use-case/startup">Startup</a>
                        <p>Track everything in project & task, helping you to take note of trends within your business.</p>
                    </div>
                    </li>
                    <li class="grid__list megamenu__item">
                    <div class="menu_icon">
                    ...
                    <div class="megamenu__link">
                        <a href="http://34.221.127.72/use-case/remote-work">Remote Work</a>
                        <p>Track everything in project & task, helping you to take note of trends within your business.</p>
                    </div>
                    </li>
                    <li class="grid__list megamenu__item">
                    ...
                    <div class="megamenu__link">
                        <a href="http://34.221.127.72/use-case/marketing">Marketing</a>
                        <p>Track everything in project & task, helping you to take note of trends within your business.</p>
                    </div>
                    </li>
                    <li class="grid__list megamenu__item">
                    ...
                    <div class="megamenu__link">
                        <a href="http://34.221.127.72/use-case/design">Design</a>
                        <p>Track everything in project & task, helping you to take note of trends within your business.</p>
                    </div>
                    </li>
                    <li class="grid__list megamenu__item">
                    ...
                    <div class="megamenu__link">
                        <a href="http://34.221.127.72/use-case/hr">HR</a>
                        <p>Track everything in project & task, helping you to take note of trends within your business.</p>
                    </div>
                    </li>
                </ul>
                <div class="text-align-center-use-case">
                    <a href="#">View All <img src="{{ url('assets/frontend/image/arrow (4) 2.png')}}" alt=""></a>
                </div>
                </ul>
            </div>
            ...
            <li class="nav__item dropdownn"><a href="#" class="nav__link dropdown__link" id="learn-header">Learn <i class="fa fa-angle-down dropdown__icon"></i></a>
            <div class="megamenu-learn-div megamenu learn-menu">
                <ul class="content">
                ...
                <ul class="content content-border-learn learn-left">
                    <img src="{{ url('assets/frontend/image/Group 1859.png')}}" alt="">
                    <h6>Learn With Slikk</h6>
                    <p>Switch to Slikk and experience the reliability</p>
                    <a href="#">Learn More <img src="{{ url('assets/frontend/image/Vector.png')}}">
                    </a>
                </ul>
            </div>
            </li>
...
<!--header on mweb-->
@include('frontnew.layouts.includes.header-mweb')
...
<div class="jumbotron text-center top-banner" style="background: transparent url(assets/frontend/image/backgroundabout.png) 0% 0% no-repeat padding-box;
            opacity: 1;
        ...
        <div class="container">
            <div class="row" style="padding-top: 40px;padding-bottom: 50px;">
                <div class="col-sm-6 box-cont">
                    <h1 class="hero_title"><span class="text-bg text-color-purple">We are Slikk:</span> Your Project Management Software</h1>
                ...
                <div class="col-sm-6">
                    <img src="{{ url('assets/frontend/image/group-of-people-working-on-problem-solution.png')}}" class="img-responsive  banner-img" style="width:100%;height:100%;"
                        />
                </div>
    ...
    <div class="row">
        <div class="col-sm-6 timeline-left  d-flex align-items-center">
            <div class="timeline-cont">
                <h1 class="timeline-title h1-heading-size">Our Story</h1>
        ...
        <div class="col-sm-6 timeline-right">
            <img src="{{ url('assets/frontend/image/business-growth.png')}}"
                style="width:100%">
        </div>

    </div>
    <h1 class="section_title h1-heading-size" style="margin-top:60px;margin-bottom:70px;text-align:left;">Our Values</h1>
    <div class="row">
        ...
        <div class="col-sm-4 card-box">
            <div class="icon-cont">
                <div class="icon-about d-flex align-items-center"
                    style="background: #FFF 0% 0% no-repeat padding-box;"><img
                        src="{{ url('assets/frontend/image/teamwork.png')}}"></div>
        ...
        <div class="col-sm-4 card-box">
            <div class="icon-cont">
                <div class="icon-about d-flex align-items-center"   style="background: #FFF 0% 0% no-repeat padding-box;"><img
                        src="{{ url('assets/frontend/image/business-collaboration.png')}}"></div>
        ...
        <div class="col-sm-4 card-box">
            <div class="icon-cont">
                <div class="icon-about d-flex align-items-center"   style="background: #FFF 0% 0% no-repeat padding-box;"><img
                        src="{{ url('assets/frontend/image/business-workflow.png')}}"></div>
        ...
        <div class="col-sm-12 bottom-cont" style="text-align:justify;margin-top:30px;">
            <div class="timeline-cont">
                <div class="timeline-p bottop-cont">
                    <h1 class="h1-heading-size">Our Mission</h1>
                    <p>Our goal is to assist CXOs, managers, and TLs in more effectively leading their teams, tracking performance, managing tasks, and bringing out the best from each employee. We believe in SMART work. We are on a mission to boost employee productivity and retention.</p>
                    <h1 class="mt-5 h1-heading-size">Work Culture</h1>
                    <p>We at Slikk have a warm, enriching, collaborative, and exciting work culture. We believe in lifting each other and helping each other grow. We encourage our employees' new ideas and visions, which are the foundation for every company's growth and improvement.</p>
                </div>
            </div>
        </div>
    </div>
...
@media screen and (min-width: 1280px){
    /* #w-node-fd549ca5-db11-5bed-6ad0-f413f31f9579-f31f9555 {
...
.footer_column-wrapper.is-last-column {
    position: relative;
    left: -47px;
}
...
@media screen and (max-width: 479px){
    #w-node-_90528466-4b8c-3d6f-b4ca-cd9ded490732-f31f9555 {
    -ms-grid-column: 1;
    grid-column-start: 1;
    -ms-grid-column-span: 1;
    grid-column-end: 2;
...
.footer_social-link-wrapper  a:hover{
    color: #fff;  
}
    </style>
        ...
        <div class="container-large">
            <div class="footer_wrapper">
                <div class="footer_column-wrapper">
                    <a href="/" aria-current="page" class="footer_brand-link w-inline-block w--current">
                    ...
                    <div class="margin-top margin-custom1">
                        <div class="text-color-off-white">Slikk.ai is the easier and efficient Productivity tool for CXOs, Managers and Teams</div>
                    </div>
                ...
                <div class="footer_column-wrapper company-footer">
                    <div class="footer_column-heading">Company</div>
                    <a href="/about-us" class="footer_link">About Us</a><a href="/pricing"
                        class="footer_link">Pricing</a>
                    <a href="/security"
                        target="_blank" class="footer_link">Security</a>
                    <a href="/privacy-policy" class="footer_link">Privacy Policy</a><a href="/terms"
                ...
                <div id="w-node-fd549ca5-db11-5bed-6ad0-f413f31f9579-f31f9555"
                    ...
                    <div class="margin-top margin-xxlarge use-case-footer">
                            <div class="footer_column-heading">Use Cases</div>
                                <a href="http://34.221.127.72/use-case/project-management" class="footer_link">Project Management</a>
                                <a href="http://34.221.127.72/use-case/software-development" class="footer_link">Software Development</a>
                                <a href="http://34.221.127.72/use-case/sales" class="footer_link">Sales</a>
                                <a href="http://34.221.127.72/use-case/startup" class="footer_link">Startup</a>
                                <a href="http://34.221.127.72/use-case/remote-work" class="footer_link">Remote Work</a>
                                <a href="http://34.221.127.72/use-case/marketing" class="footer_link">Marketing</a>
                                <a href="http://34.221.127.72/use-case/design" class="footer_link">Design</a>
                                <a href="http://34.221.127.72/use-case/hr" class="footer_link">HR</a>
                    </div>
                    <div class="footer_column-heading mt-5">Connect with us</div>
                    <div class="margin-top margin-custom3">
                            ...
                            <a href="#" target="_blank"
                                ...
                                <div class="social-link-icon w-embed">
                                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M21.5157 6.41736H22.3066V4.08398H14.8264L12.3406 13.2506H12.2726L9.80933 4.08398H2.30664V6.4173H3.07501C3.25264 6.44621 3.41744 6.52796 3.54794 6.65188C3.67844 6.77581 3.76859 6.93617 3.80664 7.11206V16.9424C3.76624 17.112 3.67413 17.2648 3.54306 17.3798C3.41198 17.4947 3.24842 17.5661 3.07501 17.584H2.30664V19.9174H8.30664V17.584H6.80664V7.25067H6.89416L10.3517 19.9174H13.0637L16.5665 7.25067H16.6401V17.584H15.14V19.9174H22.3066V17.584H21.5157C21.3462 17.5619 21.1876 17.4887 21.0609 17.374C20.9342 17.2594 20.8455 17.1088 20.8066 16.9424V7.11212C20.8434 6.93942 20.9303 6.78138 21.0564 6.6578C21.1825 6.53423 21.3423 6.45059 21.5157 6.41736V6.41736Z"
                                            fill="CurrentColor"></path>
                                    </svg>
                                </div>
                                <div class="descriptive-text">Medium Link</div>
                            </a>
                            <a href="#" target="_blank"
                                class="footer_social-link-wrapper w-inline-block">
                                <div class="social-link-icon w-embed">
                ...
                <div id="w-node-_90528466-4b8c-3d6f-b4ca-cd9ded490732-f31f9555" class="footer_column-wrapper feature-footer">
                    <div class="footer_column-heading">Features</div>
                            <a href="http://34.221.127.72/features/360-degree-visibility" class="footer_link">360° Visibility</a>
                            <a href="http://34.221.127.72/features/time-management" class="footer_link">Time Management</a>
                            <a href="http://34.221.127.72/features/task-management" class="footer_link">Task Management</a>
                            <a href="http://34.221.127.72/features/goal-management" class="footer_link">Goal Management</a>
                            <a href="http://34.221.127.72/features/kanban-boards" class="footer_link">Kanban Boards</a>
                            <a href="http://34.221.127.72/features/gantt-charts" class="footer_link">Gantt Charts</a>
                            <a href="http://34.221.127.72/features/file-sharing" class="footer_link">File Sharing</a>
                            <a href="http://34.221.127.72/features/reporting-and-analytics" class="footer_link">Reporting & Analytics</a>
                            <a href="http://34.221.127.72/features/nudge-cards" class="footer_link">Nudge Cards</a>
                            <a href="http://34.221.127.72/features/schedule-meeting" class="footer_link">Schedule Meeting</a>
                            <a href="http://34.221.127.72/features/import" class="footer_link">Import</a>
                            <a href="http://34.221.127.72/features/docs" class="footer_link">Docs</a>
            </div>
        </div>
    </div>
</footer>
...
<script src="http://34.221.127.72/assets/js/plugins.js"></script>
