        ...
        <ul class="main-ul-m">
            <li style="margin-top: 3rem;margin-bottom: 1rem;">
                ...
                <ul class="ul-bg">
                    ...
                    <li class="grid_li_m">
                    <div class="menu_icon">
                        <img src="{{ url('http://34.221.127.72/assets/frontend/image/Group 1731.png')}}" alt="">
                    </div>
                    ...
                    <li class="grid_li_m">
                        <div class="menu_icon">
                                    <img src="{{ url('http://34.221.127.72/assets/frontend/image/Group 1730.png')}}" alt="">
                                </div>
                                <div class="megamenu__link">
                    ...
                    <li class="grid_li_m">
                        <div class="menu_icon">
                                    <img src="{{ url('http://34.221.127.72/assets/frontend/image/Group 1729.png')}}" alt="">
                                </div>
                                <div class="megamenu__link">
                    ...
                    <li class="grid_li_m">
                        <div class="menu_icon">
                                    <img src="{{ url('http://34.221.127.72/assets/frontend/image/Group 1728.png')}}" alt="">
                                </div>
                                <div class="megamenu__link">
                    ...
                    <li class="grid_li_m">
                        <div class="menu_icon">
                                    <img src="{{ url('http://34.221.127.72/assets/frontend/image/Group 1727.png')}}" alt="">
                                </div>
                                <div class="megamenu__link">
                    ...
                    <li class="grid_li_m">
                        <div class="menu_icon">
                                    <img src="{{ url('http://34.221.127.72/assets/frontend/image/Group 1726.png')}}" alt="">
                                </div>
                                <div class="megamenu__link">
                    ...
                    <li class="grid_li_m">
                            <div class="menu_icon">
                                    <img src="{{ url('http://34.221.127.72/assets/frontend/image/Group 1725.png')}}" alt="">
                                </div>
                                <div class="megamenu__link">
                    ...
                    <li class="grid_li_m">
                        <div class="menu_icon">
                                    <img src="{{ url('http://34.221.127.72/assets/frontend/image/Group 1732.png')}}" alt="">
                                </div>
                                <div class="megamenu__link">
                    ...
                    <li class="grid_li_m" style="">
                            <div class="menu_icon">
                                    <img src="{{ url('http://34.221.127.72/assets/frontend/image/Group 1737.png')}}" alt="">
                                </div>
                                <div class="megamenu__link">
                    ...
                    <li class="grid_li_m" style="">
                            <div class="menu_icon">
                                    <img src="{{ url('http://34.221.127.72/assets/frontend/image/Group 1738.png')}}" alt="">
                                </div>
                                <div class="megamenu__link">
                    ...
                    <li class="grid_li_m" style="">
                            <div class="menu_icon">
                                    <img src="{{ url('http://34.221.127.72/assets/frontend/image/Group 1739.png')}}" alt="">
                                </div>
                                <div class="megamenu__link">
                    ...
                    <li class="grid_li_m" style="">
                            <div class="menu_icon">
                                    <img src="{{ url('http://34.221.127.72/assets/frontend/image/Group 1740.png')}}" alt="">
                                </div>
                                <div class="megamenu__link">
            ...
            <ul class="ul-bg">
                    <li class="grid_li_m">
                        <div class="menu_icon">
                            <img src="{{ url('http://34.221.127.72/assets/frontend/image/Group 1716.png')}}" alt="">
                        </div>
                        <div class="megamenu__link">
                    ...
                    <li class="grid_li_m">
                            <div class="menu_icon">
                                      <img src="{{ url('http://34.221.127.72/assets/frontend/image/Group 1717.png')}}" alt="">
                                  </div>
                                  <div class="megamenu__link">
                    ...
                    <li class="grid_li_m">
                        <div class="menu_icon">
                                      <img src="{{ url('http://34.221.127.72/assets/frontend/image/Group 1718.png')}}" alt="">
                                  </div>
                                  <div class="megamenu__link">
                    ...
                    <li class="grid_li_m">
                            <div class="menu_icon">
                                      <img src="{{ url('http://34.221.127.72/assets/frontend/image/Group 1719.png')}}" alt="">
                                  </div>
                                  <div class="megamenu__link">
                                    <a href="#">Help</a>
                                  </div>
