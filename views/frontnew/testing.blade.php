                    ...
                    <div class="layout-2-col">
                        <div class="feature_content-wrapper">
                            <div class="margin-top margin-medium">
                                <h2 class="faq-heading margin-heading">Get Work Done Without Chaos</h2>
                            </div>
                        </div>
                                    ...
                                    <div class="tab_text-wrapper tb-text-0" style="opacity: 1; width: 384px;">
                                        <div class="margin-top margin-xsmall">
                                            <div
                                                ...
                                                <button class="button mt-4" style="background-color: #71147e;color: #fff;">free trial</button>
                                            </div>
                                            <div class="home-tab-mob-img img-div tab_image-wrapper display-desktop">
                                                <img width="546" height="546"
                                                    src="{{ url('assets/frontend/image/industry.svg')}}"
        ...
        <div class="container-large">
            <div class="feature_component">
                <div class="layout-2-col margin-use-home">
                    ...
                    <div class="feature_content-wrapper">
                        <div class="margin-top margin-medium">
                            <h2 class="faq-heading">Use Cases For 1 to 500+ Teams</h2>
                        </div>
                    </div>
                </div>
                <div class="margin-top margin-medium">
                ...
                <div class="feature_component">
                    <div class="layout-2-col is-reverse">
                        <div class="feature_image-wrapper">
                            <div class="tab_image-wrapper is-left">
                                                            <img src="http://34.221.127.72/assets/page/360 1.png" loading="lazy" width="545" alt="Illustration showing product feature" class="tab_image-1">
                                                                <div class=""></div>
                            </div>
                        </div>
                        <div class="feature_content-wrapper">
                            <h2 class="faq-heading">Get Detailed Visuals With 360 Degree Visibility</h2>
                            <div class="margin-top margin-medium">
                                								
                                <ul class="text-ul">
                                                                        <li style="background: url('http://34.221.127.72/assets/frontend/image/work 1.png') no-repeat left center;">Relevant insights and best practices show you what's working, where you can improve, and who is doing what.</li>
                                                                        <li style="background: url('http://34.221.127.72/assets/frontend/image/work 1.png') no-repeat left center;">Get the most detailed view of your team's performance at work with easy-to-understand visuals.</li>
                                                                        <li style="background: url('http://34.221.127.72/assets/frontend/image/work 1.png') no-repeat left center;">Coordinate with stakeholders, leave feedback, and keep everyone informed, all together in Slikk.</li>
                                                                        <li style="background: url('http://34.221.127.72/assets/frontend/image/work 1.png') no-repeat left center;">Know your team’s current and next steps with this 360 degree visibility.</li>
                                                                        <li style="background: url('http://34.221.127.72/assets/frontend/image/work 1.png') no-repeat left center;">It helps you to look out for any potential risk to get it resolved beforehand.</li>
                                                                    </ul>
                            </div>
                        </div>
                    </div>
...
<section id="listen" class="margin-top-8rem-m section-product-feature">
    <div class="page-padding">
        <div class="container-large">
            <div class="padding-top padding-huge">
                <div class="feature_component">
                    <div class="layout-2-col">
                        <div class="feature_content-wrapper">
                            <h2 class="faq-heading">360 Degree Visibility: View That Notices Minute Details</h2>
                            <div class="margin-top margin-medium">
                            								
                            <ul class="text-ul">
                                                                <li style="background: url('http://34.221.127.72/assets/frontend/image/team 1.png') no-repeat left center;">The 360 degree visibility lets you demonstrate results in the best way possible.</li>
                                                                <li style="background: url('http://34.221.127.72/assets/frontend/image/team 1.png') no-repeat left center;">Slikk‘s productivity tool provides the metrics your teams need to prove ROI.</li>
                                                                <li style="background: url('http://34.221.127.72/assets/frontend/image/team 1.png') no-repeat left center;">See a complete set of assignments to assess, prioritize, and group budget.</li>
                                                                <li style="background: url('http://34.221.127.72/assets/frontend/image/team 1.png') no-repeat left center;">Create and view portfolio assignments with Slikk’s 360 degree visibility feature.</li>
                                                                <li style="background: url('http://34.221.127.72/assets/frontend/image/team 1.png') no-repeat left center;">It effectively prioritizes tasks and makes greater choices to accomplish better results.</li>
                                                            </ul></div>
                        </div>
                        <div class="feature_image-wrapper">
                            <div class="tab_image-wrapper">
                                                            <img src="http://34.221.127.72/assets/page/360 2.png" loading="lazy" width="274.5" alt="Illustration showing product feature" class="tab_image-1">
                                                                <div class=""></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="padding-top padding-xhuge">
                <div class="feature_component">
                    <div class="layout-2-col is-reverse">
                        <div class="feature_image-wrapper">
                            <div class="tab_image-wrapper is-left">
                                                            <img src="http://34.221.127.72/assets/page/360 3.png" loading="lazy" width="545" alt="Illustration showing product feature" class="tab_image-1">
                                                                <div class=""></div>
                            </div>
                        </div>
                        <div class="feature_content-wrapper">
                            <h2 class="faq-heading">A Clear Picture With 360 Degree Visibility</h2>
                            <div class="margin-top margin-medium">
                                								
                                <ul class="text-ul">
                                                                        <li style="background: url('http://34.221.127.72/assets/frontend/image/work 1.png') no-repeat left center;">The 360 degree visibility offers multiple views to get transparency on projects.</li>
                                                                        <li style="background: url('http://34.221.127.72/assets/frontend/image/work 1.png') no-repeat left center;">Find and fix anything that lowers the productivity of your teams.</li>
                                                                        <li style="background: url('http://34.221.127.72/assets/frontend/image/work 1.png') no-repeat left center;">Get graphs and charts to know workload distribution and task progress.</li>
                                                                        <li style="background: url('http://34.221.127.72/assets/frontend/image/work 1.png') no-repeat left center;">Know your short-term and long-term operations and assign them accordingly.</li>
                                                                        <li style="background: url('http://34.221.127.72/assets/frontend/image/work 1.png') no-repeat left center;">Get a superior view of your tasks to know the loopholes and the task completion date.</li>
                                                                    </ul>
                            </div>
                        </div>
                    </div>
