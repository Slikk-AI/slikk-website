...
.navs ul li:first-child {padding-left: 0;}
.navs ul li:last-child {padding-right: 0;}
.navs ul li > a {
	color: #fff;
  	display: block;
  	position: relative;
...
–––––––––––––––––––––––––––––––––––––––––––––––––– */
.droppable {position: static !important;}
.droppable > a:after {
	content: "\f107";
...
.nav-mob {
  ...
  width: 100%;
  background: #5433ff;
  box-shadow: 0px 3px #14008A;
  z-index: 999;
}
.nav-mob .logo {
  color: #fff;
  text-decoration-color: #14008A;
  font-size: 22px;
  font-family: "Playfair Display", serif;
  font-weight: 100;0px 3px #14008A
}
.nav-mob ul {
  --padding: 20px;
  --font-size: 17px;
...
.navs .menu.active span:nth-child(1) {
...
.nav-mob ul {
  ...
  .nav-mob ul.active {
    --height: calc(
      (((var(20px) * 2) + (var(17px) * 1.5))) * var(--childenNumber)
    );
...
<nav class="header__containerr navs desk-show">
  <ul class="hed-cont container ul-reset">
        ...
        <div class="container cf">
            <div class="features">
              ...
              <ul class="ul-reset">
                ...
                <li class="margin-leftt"><a href='https://slikk.ai/features/360-degree-visibility'>360° Visibility</a></li>
              ...
              <ul class="ul-reset">
              <li class="margin-leftt"><a href='https://slikk.ai/features/file-sharing'>File Sharing</a></li>
            ...
            <div class="features">
              ...
              <ul class="ul-reset">
                ...
                <li class="margin-leftt"><a href='https://slikk.ai/use-case/project-management'>Project Management</a></li>
              ...
              <ul class="ul-reset">
                ...
                <li class="margin-leftt"><a href='https://slikk.ai/use-case/remote-work'>Remote Work</a></li>
